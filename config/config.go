...
func Load() Config {
	...
	config.ServiceName = cast.ToString(getOrReturnDefaultValue("SERVICE_NAME", "rest_service"))
	...
	config.PostgresPassword = cast.ToString(getOrReturnDefaultValue("POSTGRES_PASSWORD", "7007"))
